...
<table border="0" cellpadding="0" cellspacing="2" width="100%">
 ...
    <td width="780px" class="main2"><b>ZwDConfig V1.3</b></td>
  ...
  <tr>
    <td width="100px" class="main2"><b>Novidades v1.3</b></td><td width="780px">Correções de erros, Melhorias das funções, funções Novas: 1) Mudar nome de usuario, 2) Backup dos usuarios, 3) Restauração de usuarios, 4) Remover todos os usuarios, 5) Excluir Backup, 6) SpeedTest, 7) Excluir um usuario do Backup.</td>
  </tr>
  <tr>
