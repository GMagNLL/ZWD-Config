...
<table border="0" cellpadding="0" cellspacing="2" width="100%">
 ...
    <td width="780px" class="main2"><b>ZWDConfig V1.4</b></td>
  <tr>
    <td width="100px" class="main2"><b>Author:</b></td><td width="780px">Zwdeff</td>
  </tr>
  <tr>
    <td width="100px" class="main2"><b>Versão:</b></td><td width="780px">1.4</td>
  </tr>
  <tr>
  ...
  <tr>
    <td width="100px" class="main2"><b>Novidades v1.4</b></td><td width="780px">Correções de erros, Melhorias.</td>
  </tr>
  <tr>
