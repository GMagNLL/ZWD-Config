         ...
         or w == '8' or w == '9' or w == '0' or w == 'm' or w == 'M' or w == 'monitor'\
          or w == 'Monitor' or w == 'MONITOR' or w == 'i' or w == 'I':
           if w == 'i' or w == 'I':
              ...
              print ('\033[92m\nIPAddress\033[32m: %s' % (web))
              print ('\033[32mPais\033[92m: %s' % (con))
              print ('\033[92mPais Code\033[32m: %s' % (coc))
              print ('\033[32mHospedado por\033[92m: %s' % (hos))
              print ('\033[92mProvedor\033[32m: %s' % (isp))
              print ('\033[32mCidade\033[92m: %s' % (cyt))
              print ('\033[92mRegiao:\033[32m %s' % (rgn))
              print ('\033[32mRegiao Code\033[92m: %s' % (rgc))
              print ('\033[92mFuso horario\033[32m: %s' % (tif))
              if json_data['zip'] == '':
                 zii = 'Null'
              print ('\033[32mZip\033[92m: %s' % (zii))
              print ('\033[92mStatus\033[32m: %s' % (sta))
              print ('\033[32mLat/Long\033[32m: %s, %s' % (lat,lon))
              w = input(f6+'\n :: _\033[92m'+' ')
           ...
           if w == 'm' or w == 'M' or w == 'monitor' or w == 'Monitor' or w == 'MONITOR':
              ...
              system('''time=$(uptime | awk '{print $3,$4}' | cut -f1 -d,)\n
                     echo '\033[32mTempo de Aatividade\033[92m:' $time''')
              w = input(f6+'\n :: _\033[92m'+' ')
           ...
           if w == '6':
              rb = input(f6+'\nDeseja deletar o Banner por completo\n ficarar como de'\
